...
if (toggleNavClass === false) { 
  ...
  <div class="container-fluid "> <Link to='/' name='two' onClick={incrementHandler} className="btn text-light btn-outline-* fs-1 navbar-brand">Love-Mambo</Link>
    ...
    <div class=' collapse navbar-collapse justify-content-md-end ' id="navbarTogglerDemo02">
      ...
      <Link to={'/shop'} onClick={incrementHandler} className='me-3 btn text-light btn-outline-* fs-4 nav-item' data-bs-toggle="collapse" data-bs-target="#navbarTogglerDemo02" name='one'  >Shop</Link>
  ...
  <div class="container-fluid "> <Link to='/' name='two' onClick={incrementHandler} className="btn  text-dark btn-outline-* fs-1 navbar-brand">Love-Mambo</Link>
    ...
    <div class=' collapse navbar-collapse justify-content-md-end ' id="navbarTogglerDemo02">
      ...
      <Nav.Link to='/shop' onClick={incrementHandler} className='me-3 btn  text-dark btn-outline-* fs-4 nav-item' data-bs-toggle="collapse" data-bs-target="#navbarTogglerDemo02" name='one'  >Shop</Nav.Link>
